...
const appCss = "/assets/styles-CzOo0w-g.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "SIREGA — Sistema Integral de Registro y Evaluación Ganadera" },
      { name: "description", content: "Plataforma agrotecnológica para el registro, trazabilidad y evaluación inteligente de tu hato ganadero." },
      { name: "author", content: "SIREGA" },
      { property: "og:title", content: "SIREGA — Agrotecnología para la ganadería moderna" },
      { property: "og:description", content: "Registra, evalúa y optimiza tu producción ganadera con datos en tiempo real." },
...
const $$splitComponentImporter = () => import("./index-BA_58o4u.js");
